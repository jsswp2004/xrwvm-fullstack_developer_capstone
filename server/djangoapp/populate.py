...
def initiate():
    ...
    # Create CarModel instances with assigned dealer_id
    car_model_data = [
    ...
    # Assign unique dealer_id values (iterating from 1)
    dealer_id_counter = 1
    ...
    for data in car_model_data:
        CarModel.objects.create(
            ...
            type=data['type'],
            year=data['year'],
            dealer_id=dealer_id_counter  # Assign unique dealer_id
        )
        dealer_id_counter += 1  # Increment dealer_id for each model
