...
const PostReview = () => {
  ...
  const postreview = async () => {
    ...
    let model_chosen = model_split.slice(1).join(" "); // allow multi-word models
    ...
    try {
      const res = await fetch(review_url, {
        ...
        credentials: "include", // 🔐 needed if using Django sessions
  ...
  return (
    <div>
      ...
      <div style={{ margin: "5%" }}>
        ...
        <div className='input_field'>
          Car Year <input type="number" value={year} onChange={(e) => setYear(e.target.value)} max={2025} min={2015} />
        </div>
